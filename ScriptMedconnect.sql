...
-- TESTES INSERTS MES:
-- LATENCIA DE REDE
INSERT INTO Registros VALUES(NULL, 2, "2023-10-23 18:00:00", 12, 16),
(NULL, 2, "2023-10-22 19:00:00", 1, 16),
(NULL, 2,"2023-10-21 17:00:00", 23, 16),
(NULL, 2,"2023-10-20 16:00:00", 34, 16),
(NULL, 2,"2023-10-19 15:00:00", 89, 16),
(NULL, 2,"2023-10-18 13:00:00", 40, 16),
(NULL, 2, "2023-10-16 14:00:00", 20, 16);

-- PORCENTAGEM CPU
INSERT INTO Registros VALUES
(NULL, 2, "2023-10-23 18:00:00", 10, 1),
(NULL, 2, "2023-10-21 19:00:00", 20, 1),
(NULL, 2,"2023-10-20 17:00:00", 53, 1),
(NULL, 2,"2023-10-12 16:00:00", 12, 1),
(NULL, 2,"2023-10-13 15:00:00", 61, 1),
(NULL, 2,"2023-10-15 13:00:00", 21, 1),
(NULL, 2, "2023-10-19 14:00:00", 91, 1);

select * from registros where fkRoboregistro = 2;

-- PORCENTAGEM MEMORIA
INSERT INTO Registros VALUES
(NULL, 2, "2023-10-23 18:00:00", 21, 5),
(NULL, 2, "2023-10-22 19:00:00", 41, 5),
(NULL, 2,"2023-10-21 17:00:00", 11, 5),
(NULL, 2,"2023-10-20 16:00:00", 14, 5),
(NULL, 2,"2023-10-12 15:00:00", 12, 5),
(NULL, 2,"2023-10-13 13:00:00", 26, 5),
(NULL, 2, "2023-10-17 14:00:00", 39, 5);


-- TESTES INSERT ANO
-- LATENCIA DE REDE
INSERT INTO Registros VALUES(NULL, 2, "2023-10-23 18:00:00", 12, 16),
(NULL, 2, "2023-09-22 19:00:00", 1, 16),
(NULL, 2,"2023-08-21 17:00:00", 23, 16),
(NULL, 2,"2023-07-20 16:00:00", 34, 16),
(NULL, 2,"2023-06-19 15:00:00", 89, 16),
(NULL, 2,"2023-05-18 13:00:00", 40, 16),
(NULL, 2, "2023-04-16 14:00:00", 20, 16);

-- PORCENTAGEM CPU
INSERT INTO Registros VALUES
(NULL, 2, "2023-10-23 18:00:00", 10, 1),
(NULL, 2, "2023-10-21 19:00:00", 20, 1),
(NULL, 2,"2023-08-20 17:00:00", 53, 1),
(NULL, 2,"2023-09-12 16:00:00", 12, 1),
(NULL, 2,"2023-04-13 15:00:00", 61, 1),
(NULL, 2,"2023-02-15 13:00:00", 21, 1),
(NULL, 2, "2023-01-19 14:00:00", 91, 1);
...
INSERT INTO Registros VALUES
(NULL, 2, "2023-10-23 18:00:00", 21, 5),
(NULL, 2, "2023-01-22 19:00:00", 41, 5),
(NULL, 2,"2023-02-21 17:00:00", 11, 5),
(NULL, 2,"2023-03-20 16:00:00", 14, 5),
(NULL, 2,"2023-06-12 15:00:00", 12, 5),
(NULL, 2,"2023-07-13 13:00:00", 26, 5),
(NULL, 2, "2023-09-17 14:00:00", 39, 5);
